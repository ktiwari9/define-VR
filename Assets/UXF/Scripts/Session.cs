...
namespace UXF
{
    ...
    public class Session : MonoBehaviour
    {
        ...
        /// <summary>
        /// The controller of the highscore listings.
        /// </summary>
        [HideInInspector]
        ...
        /// <summary>
        /// List of variables you plan to keep a highscore in your experiment. Be sure to only list headers that are being stored in results.
        /// </summary>
        [Tooltip("List of variables you plan to keep a highscore in your experiment. Be sure to only list headers that are being stored in results.")]
        public string headerToHighscore = "";
        ...
        /// <summary>
        /// Event(s) to trigger when the trial has been paused.
        /// </summary>
        /// <returns></returns>
        [Tooltip("Event(s) to trigger when the experiment is paused.")]
        public TrialEvent onPause = new TrialEvent();

        /// <summary>
        /// Event(s) to trigger when the trial has been unpaused.
        /// </summary>
        /// <returns></returns>
        [Tooltip("Event(s) to trigger when the experiment is unpaused.")]
        public TrialEvent onUnPause = new TrialEvent();

        /// <summary>
        /// Event(s) to trigger when a new highscore has been made to the list.
        /// </summary>
        /// <returns></returns>
        [Tooltip("Event(s) to trigger when a new highscore has been made to the list.")]
        public TrialEvent onNewHighscore = new TrialEvent();
        ...
        /// <summary>
        /// Settings for the experiment locomotion method. These are provided on initialisation of the session.
        /// </summary>
        public Settings locomotionSettings;

        /// <summary>
        /// Settings for the experiment environment. These are provided on initialisation of the session.
        /// </summary>
        public Settings scoreSettings;
        ...
        /// <summary>
        /// Settings for the experiment scenario. These are provided on initialisation of the session.
        /// </summary>
        public Settings scenarioSettings;
        ...
        /// <summary>
        /// An indicator if the session has been aborted and should be treated as bad.
        /// </summary>
        ...
        void Awake()
        {
            ...
            AttachReferences(GetComponent<FileIOManager>(), GetComponent<HighScoreController>());
        }
        ...
        public void AttachReferences(FileIOManager newFileIOManager = null, HighScoreController newHighScoreController = null)
        {
            if (newFileIOManager != null) fileIOManager = newFileIOManager;
            if(newHighScoreController != null) highScoreController = newHighScoreController;
        }
        ...
        public void Begin(string experimentName, string participantId, string baseFolder, int sessionNumber = 1, Dictionary<string, object> participantDetails = null, Settings locomotionSettings = null, Settings scoreSettings = null, Settings scenarioSettings = null, Settings environmentSettings = null)
        {
            ...
            if (locomotionSettings == null)
                locomotionSettings = Settings.empty;
            this.locomotionSettings = locomotionSettings;

            if (scenarioSettings == null)
                scenarioSettings = Settings.empty;
            this.scenarioSettings = scenarioSettings;

            if (environmentSettings == null)
                environmentSettings = Settings.empty;
            this.environmentSettings = environmentSettings;

            if (scoreSettings == null)
                scoreSettings = Settings.empty;
            ...
            // setup highscore controller
            highScoreController.SetReferences(this, fileIOManager, BasePath);
            ...
            WriteDictToSessionFolder(
                new Dictionary<string, object>(environmentSettings.baseDict), // makes a copy
                "environmentSettings");
            WriteDictToSessionFolder(
                new Dictionary<string, object>(locomotionSettings.baseDict), // makes a copy
                "locomotionSettings");
            WriteDictToSessionFolder(
                new Dictionary<string, object>(scenarioSettings.baseDict), // makes a copy
                "scenarioSettings");
            WriteDictToSessionFolder(
                new Dictionary<string, object>(scoreSettings.baseDict), // makes a copy
                "scoreSettings");
        }
        ...
        /// <summary>
        /// Pauses currently running trial. Useful to call from an inspector event
        /// </summary>
        ...
        /// <summary>
        /// Aborts the session and marks the experiment as bad.
        /// </summary>
        ...
        /// </summary>
        public void End(bool abort = false)
        {
            if (hasInitialised)
            {
                if (InTrial)
                ...
                // Cancel autopilot and mark session as bad
                if (abort)
                {
                    transform.Find("[UXF_UI]").Find("NotesPanel").GetComponent<NotesController>().ignoreCheckbox.isOn = true;
                    transform.Find("[UXF_UI]").GetComponent<ExperimentStartupController>().AutopilotToggle.isOn = false;
                }
                ...
                //fileIOManager.End(); // TODO: workaround this?
