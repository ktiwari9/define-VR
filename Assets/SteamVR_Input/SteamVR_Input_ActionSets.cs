...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_vr_interaction p_vr_interaction;
        ...
        public static SteamVR_Input_ActionSet_vr_interaction vr_interaction
        {
            get
            {
                return SteamVR_Actions.p_vr_interaction.GetCopy<SteamVR_Input_ActionSet_vr_interaction>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_vr_interaction = ((SteamVR_Input_ActionSet_vr_interaction)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_vr_interaction>("/actions/vr_interaction")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.vr_interaction};
        }
    }
}
